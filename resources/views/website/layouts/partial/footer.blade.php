     ...
     <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
         <div class="xl:grid xl:grid-cols-3 xl:gap-8">
             <div class="space-y-8 xl:col-span-1">
                 <span class="text-2xl font-bold text-white">RoomYatra</span>
                 <p class="text-gray-300 text-base">
                     Making room rentals simple and secure for landlords and tenants.
                 </p>
                 ...
                 <div class="md:grid md:grid-cols-2 md:gap-8">
                     <div>
                         ...
                         <ul class="mt-4 space-y-4">
                             <li>
                                 <a href="/rooms" class="text-base text-gray-300 hover:text-white">
                                     Find a Room
                                 </a>
                             </li>
                             <li>
                                 <a href="/how-it-works" class="text-base text-gray-300 hover:text-white">
                                     How It Works
                                 </a>
                             </li>
