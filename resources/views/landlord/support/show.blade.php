                ...
                @if(!in_array($ticket->status, ['resolved', 'closed']))
                    <div class="bg-white shadow-sm rounded-lg">
                        <div class="p-6">
                            ...
                            <form action="{{ route('landlord.support.update', $ticket) }}" method="POST" class="space-y-4">
                                @csrf
                                @method('PUT')
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4" required
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent">{{ $ticket->description }}</textarea>
                                </div>
                ...
                @if(in_array($ticket->status, ['open', 'in_progress']))
                    <div class="bg-white shadow-sm rounded-lg">
                        <div class="p-6">
                            ...
                            <form action="{{ route('landlord.support.cancel', $ticket) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <button type="submit" 
