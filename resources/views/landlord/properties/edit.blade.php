                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $property->description) }}</textarea>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <select id="price_type" name="price_type"
                                ...
                                <option value="monthly"
                                    {{ old('price_type', $property->price_type) == 'monthly' ? 'selected' : '' }}>Monthly
                                </option>
                                <option value="weekly"
                                    {{ old('price_type', $property->price_type) == 'weekly' ? 'selected' : '' }}>Weekly
                                </option>
                                <option value="daily"
                                    {{ old('price_type', $property->price_type) == 'daily' ? 'selected' : '' }}>Daily
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input type="number" name="size" id="size" value="{{ old('size', $property->size) }}"
                                class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input type="number" name="bathrooms" id="bathrooms"
                                value="{{ old('bathrooms', $property->bathrooms) }}" min="0" step="0.5"
                                class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                            ...
                            <div class="flex items-start mt-6">
                                <div class="flex items-center h-5">
                                    <input id="is_furnished" name="is_furnished" type="checkbox" value="1"
                                        {{ old('is_furnished', $property->is_furnished) ? 'checked' : '' }}
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="date" name="available_to" id="available_to"
                                value="{{ old('available_to', $property->available_to ? $property->available_to->format('Y-m-d') : '') }}"
                                class="mt-1 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                                            ...
                                            <div class="flex items-start mb-2">
                                                <div class="flex items-center h-5">
                                                    <input id="amenity_{{ $amenity->id }}" name="amenities[]"
                                                        ...
                                                        {{ is_array(old('amenities', $property->amenities->pluck('id')->toArray())) && in_array($amenity->id, old('amenities', $property->amenities->pluck('id')->toArray())) ? 'checked' : '' }}
                                                        class="focus:ring-rose-500 h-4 w-4 text-rose-600 border-gray-300 rounded">
                                                </div>
                                                <div class="ml-3 text-sm">
                        ...
                        <!-- Current Images -->
                        <div class="col-span-6">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Current Images</h3>
                            <p class="mt-1 text-sm text-gray-500">Select a primary image and/or delete existing images.</p>
                        </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col items-center space-y-2">
                                                <div class="flex items-center">
                                                    <input type="radio" id="primary_{{ $image->id }}"
                                                        name="primary_image" value="{{ $image->id }}"
                                                        {{ $image->is_primary ? 'checked' : '' }}
                                                        class="focus:ring-rose-500 h-4 w-4 text-rose-600 border-gray-300">
                                                    <label for="primary_{{ $image->id }}"
                                                        class="ml-2 text-xs text-white">Primary</label>
                                                </div>
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="delete_{{ $image->id }}"
                                                        name="delete_images[]" value="{{ $image->id }}"
                                                        class="focus:ring-rose-500 h-4 w-4 text-rose-600 border-gray-300 rounded">
                                                    <label for="delete_{{ $image->id }}"
                                                        class="ml-2 text-xs text-white">Delete</label>
                                                </div>
                                            </div>
                                        </div>
                                        @if ($image->is_primary)
                                            <div
                                                class="absolute top-0 right-0 bg-rose-500 text-white text-xs px-2 py-1 rounded-bl">
                                                Primary
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <!-- New Images -->
                        <div class="col-span-6">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Add New Images</h3>
                            <p class="mt-1 text-sm text-gray-500">Upload additional images for your property.</p>
                        </div>
                        ...
                        <div class="col-span-6">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="new_images"
                                            ...
                                            <input id="new_images" name="new_images[]" type="file" multiple
                            ...
                            <div id="image-preview"
                                class="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4"></div>
                        </div>
                    </div>
                </div>
